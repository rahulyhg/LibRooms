<?php /* Smarty version Smarty-3.1.7, created on 2013-03-20 14:57:50
         compiled from "/var/www/html/webenv/schedule/lib/Common/../../tpl/Admin/manage_schedules.tpl" */ ?>
<?php /*%%SmartyHeaderCode:743086573514a22cecd7ac4-30080830%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8c636fed11e462f7c8316900e15db376f30a5f82' => 
    array (
      0 => '/var/www/html/webenv/schedule/lib/Common/../../tpl/Admin/manage_schedules.tpl',
      1 => 1363802528,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '743086573514a22cecd7ac4-30080830',
  'function' => 
  array (
    'display_periods' => 
    array (
  ...
  'unifunc' => 'content_514a22cf1bdcc',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_514a22cf1bdcc')) {function content_514a22cf1bdcc($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include '/var/www/html/webenv/schedule/lib/Common/../../lib/external/Smarty/plugins/function.html_options.php';
?>
...
"/>
			...
			<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>"LayoutDescription",'args'=>($_smarty_tpl->tpl_vars['dayName']->value).", ".($_smarty_tpl->tpl_vars['daysVisible']->value)),$_smarty_tpl);?>
...
">
			...
			<?php if ($_smarty_tpl->tpl_vars['day']->value!=null){?>
				<?php $_smarty_tpl->tpl_vars['suffix'] = new Smarty_variable("_".($_smarty_tpl->tpl_vars['day']->value), null, 0);?>
			<?php }?>
            <div style="float:left;">
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
			...
			<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'QuickSlotCreation','args'=>($_smarty_tpl->tpl_vars['layoutConfig']->value).",".($_smarty_tpl->tpl_vars['layoutStart']->value).",".($_smarty_tpl->tpl_vars['layoutEnd']->value)),$_smarty_tpl);?>
...
<script type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['Path']->value;?>
scripts/admin/schedule.js"></script>
<script type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['Path']->value;?>
