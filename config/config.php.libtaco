...
$conf['settings']['script.url'] = 'http://libtaco-dev.unm.edu/schedule';   	// public URL to the Web directory of this phpScheduleIt instance. this is the URL that appears when you are logging in
