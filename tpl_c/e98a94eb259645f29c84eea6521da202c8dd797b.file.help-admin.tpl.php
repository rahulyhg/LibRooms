<?php /* Smarty version Smarty-3.1.7, created on 2013-03-22 14:57:58
         compiled from "/var/www/html/webenv/schedule/lib/Common/../../lang/en_us/help-admin.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1309842627514cc5d6dd41e7-21981595%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e98a94eb259645f29c84eea6521da202c8dd797b' => 
    array (
      0 => '/var/www/html/webenv/schedule/lib/Common/../../lang/en_us/help-admin.tpl',
      1 => 1363802527,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1309842627514cc5d6dd41e7-21981595',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_514cc5d6e2b25',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_514cc5d6e2b25')) {function content_514cc5d6e2b25($_smarty_tpl) {?>
...
<p class="setting"><span>$conf['settings']['server.timezone']</span>This must reflect the timezone of the server that
    phpScheduleIt is hosted on. This server is currently set to <em><?php echo $_smarty_tpl->tpl_vars['ServerTimezone']->value;?>
</em>. Possible values are located here:
...
<p class="setting"><span>$conf['settings']['schedule']['reservation.label']</span>The format of what to display for the
    reservation slot on the Bookings page. Available tokens are {name}, {title}, {description}, {email},
    {phone}
